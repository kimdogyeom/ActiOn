...
async def process_full_workflow(file: UploadFile = File(...)):
    """
    Complete workflow: Upload -> Transcribe -> Extract -> Push to Notion.
    ...
    """
    logger.info(f"Starting full workflow for file: {file.filename}")
